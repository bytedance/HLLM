...
class Attention(nn.Module):
    ...
    def forward(
        ...
        if self.use_ft_flash_attn:
            ...
            # problem with compress pretrain
...
class BaichuanModel(BaichuanPreTrainedModel):
    ...
    def forward(
            ...
            inputs_action_embeds: Optional[torch.FloatTensor] = None,
        ...
        for idx, decoder_layer in enumerate(self.layers):
            if inputs_action_embeds is not None:
                hidden_states = hidden_states + inputs_action_embeds[idx]
...
class BaichuanForCausalLM(BaichuanPreTrainedModel):
    ...
    def forward(
        ...
        outputs = self.model(
            ...
            inputs_action_embeds=inputs_action_embeds,
            use_cache=use_cache,
            output_attentions=output_attentions,
